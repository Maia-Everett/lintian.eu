...
As an example, here's the [list of open questions](/bits/open-questions-heavensward/) (MASSIVE SPOILERS) that I wrote after finishing the first expansion, Heavensward. Most of those questions were answered by later expansions, and some turned out to be based on invalid assumptions. But now, as the 7.0 expansion, Dawntrail, is about to launch, there is still a lot we don't know about the FFXIV universe, and neither do the characters.
