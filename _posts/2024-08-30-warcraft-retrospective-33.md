...
{% figure [caption:"Apparently they put that cage on the base of a glaive thrower."] %}
![The Search for Illidan](/assets/wr/20240821230100_1.jpg)
{% endfigure %}
...
{% figure [caption:"Oh, hello again. Remember when we were on the same side? I kind of miss that."] %}
![The Search for Illidan](/assets/wr/20240825231913_1.jpg)
{% endfigure %}

The map is basically symmetric; there are two bases here, ours and Maiev's. We control the two heroes only[^pandaren] while our regular troops automatically engage the night elves. Illidan's cage rolls ssssslooooowly towards the base of whichever side controls it at the moment. To claim the cage, a side needs to bring its hero to it without an enemy hero being nearby.
...
{% figure [caption:"Pledge is too strong a word. More like a mutually beneficial partnership."] %}
![The Search for Illidan](/assets/wr/20240825233117_1.jpg)
{% endfigure %}
